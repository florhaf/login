Ext.define("Login.view.LegalNotice", {
    ...
    config: {
        ...
        items: [{
            ...
            html: '<div style="width : 100%; height: 100%; padding: 10px;"><h1>Morgan Stanley Systems and Assets Login Notification</h1><br />'+
                '<p>Use Morgan Stanley&#39;s systems and assets (such as telephones, computer networks, Internet access facilities, '+
                'Firm-approved messaging systems and other communication facilities) only for Morgan Stanley business and ' +
